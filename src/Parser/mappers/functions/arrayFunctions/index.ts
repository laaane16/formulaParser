...
export const arrayFunctions: Record<
  ValidArrayFunctionsNames,
  VariableFunction
> = {
  INDEX: [
    {
      args: [{ type: [LITERAL_ARRAY_NODE_TYPE] }, { type: [NUMBER_NODE_TYPE] }],
      returnType: [LITERAL_NODE_TYPE],
      jsFn: arrayFunctionsToJsMap.INDEX,
      sqlFn: arrayFunctionsToSqlMap.INDEX,
    },
    {
      args: [{ type: [NUMBER_ARRAY_NODE_TYPE] }, { type: [NUMBER_NODE_TYPE] }],
      returnType: [NUMBER_NODE_TYPE],
      jsFn: arrayFunctionsToJsMap.INDEX,
      sqlFn: arrayFunctionsToSqlMap.INDEX,
    },
    {
      args: [{ type: [DATE_ARRAY_NODE_TYPE] }, { type: [NUMBER_NODE_TYPE] }],
      returnType: [DATE_NODE_TYPE],
      jsFn: arrayFunctionsToJsMap.INDEX,
      sqlFn: arrayFunctionsToSqlMap.INDEX,
    },
    {
      args: [{ type: [BOOLEAN_ARRAY_NODE_TYPE] }, { type: [NUMBER_NODE_TYPE] }],
  ...
  FIND: [
    ...
    {
      args: [{ type: [DATE_ARRAY_NODE_TYPE] }, { type: [DATE_NODE_TYPE] }],
      returnType: [DATE_NODE_TYPE],
      jsFn: arrayFunctionsToJsMap.FIND,
      sqlFn: arrayFunctionsToSqlMap.FIND,
    },
